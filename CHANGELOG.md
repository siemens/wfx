...
- Sign and upload CycloneDX SBOMs for container images and binaries into OCI registry with Cosign attestations
...
- Make non-structured log messages self-contained by embedding relevant identifiers directly into human-readable messages
...
- UI: show details from rsvp errors (HTTP body, bad URL, JSON decode error)
