...
wfx releases include [CycloneDX](https://cyclonedx.org/) and [SPDX](https://spdx.github.io/spdx-spec/) Software Bill of Materials (SBOM) files:

- Release archives include SBOM files for wfx binaries and WebUI assets.
...
### Example: Verify attestation of CycloneDX SBOM
