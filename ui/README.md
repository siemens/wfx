...
so include it in `scope` as shown above. When present, the UI automatically refreshes the access token
using the refresh token 60 seconds before expiration.
