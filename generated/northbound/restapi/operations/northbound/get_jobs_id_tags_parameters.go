...
// GetJobsIDTagsParams contains all the bound params for the get jobs ID tags operation
...
func (o *GetJobsIDTagsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
