...
func (o *GetJobsIDDefinitionURL) WithBasePath(bp string) *GetJobsIDDefinitionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetJobsIDDefinitionURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetJobsIDDefinitionURL")
	}
...
func (o *GetJobsIDDefinitionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetJobsIDDefinitionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetJobsIDDefinitionURL")
	}
