...
func (_q *HistoryQuery) QueryJob() *JobQuery {
...
func (_q *HistoryQuery) WithJob(opts ...func(*JobQuery)) *HistoryQuery {
	query := (&JobClient{config: _q.config}).Query()
...
func (_q *HistoryQuery) loadJob(ctx context.Context, query *JobQuery, nodes []*History, init func(*History), assign func(*History, *Job)) error {
