...
func (o *PutJobsIDStatusURL) Build() (*url.URL, error) {
	...
	var _path = "/jobs/{id}/status"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on PutJobsIDStatusURL")
	}
...
func (o *PutJobsIDStatusURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutJobsIDStatusURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutJobsIDStatusURL")
	}
