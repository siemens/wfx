...
func (o *GetJobsIDTagsURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetJobsIDTagsURL")
	}
...
func (o *GetJobsIDTagsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetJobsIDTagsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetJobsIDTagsURL")
	}
