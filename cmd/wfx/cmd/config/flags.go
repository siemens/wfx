...
const (
	...
	DefaultPingIntervalSSE = 15 * time.Second
)
...
func NewFlagset() *pflag.FlagSet {
	...
	f.Duration(PingIntervalSSEFlag, DefaultPingIntervalSSE, "interval to send periodic keep-alive messages to prevent the connection from being closed")
