...
const (
	...
	SSEGraceDurationFlag = "sse-grace-period"
...
const (
	...
	DefaultSSEGraceDuration = time.Minute
)
...
func NewFlagset() *pflag.FlagSet {
	...
	f.Duration(SSEGraceDurationFlag, DefaultSSEGraceDuration, "duration after which non-responsive subscribers are dropped")
