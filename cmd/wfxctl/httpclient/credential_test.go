...
func TestCredentialUnknownKeyWarns(t *testing.T) {
	...
	require.NoError(t, editor(req.Context(), req))
	assert.Contains(t, buf.String(), `"key":"unknown"`)
	assert.Contains(t, buf.String(), "Unknown credential helper response key")
